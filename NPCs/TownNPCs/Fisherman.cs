	...
	public class Fisherman : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("Mods.FishermanNPC.Bestiary.Fisherman.General"),
		...
		public override string GetChat()
		{
			...
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChat1"));
			//Greetings. Care to do some fishin'?
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChat2"));
			//I got all the supplies you'd need if you want to do some fishin'.
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChat3"));
			//Fishing rods? Bait? Hooks? You want it?
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChat4"));
			//Make sure you have bait on your hook.
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChat5") + " " + Main.npc[fisherman].GivenName + ".");
			//Ahoy there. My name is {Name}
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChat6"));
			//There are all sorts of strange fish in these waters; see what you can catch!
			chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DefaultChatRare"), 0.1);
			//Hm... I seem to have misplaced my rod...

			if (NPC.life < NPC.lifeMax * 0.5)
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.Hurt"), 10.0);
				//That's gonna leave a mark.
			}
			if (Main.dayTime)
			{
				chat.Add(Main.raining ? Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DayTimeRaining") : Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.DayTime"));
				//Rain is the perfect time to do some fishin'!
				//A nice sunny day today.
			}
			else
			{
				chat.Add(Main.raining ? Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.NightTimeRaining") : Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.NightTime"));
				//Careful out there. There's a nasty storm out tonight!
				//Time to get some shut-eye.
			}
			if (NPC.homeless)
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.Homeless"));
				//Could you provide me with a vessel of some sort? A man needs a place to sleep!
			}
			else
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.HasHome"));
				//Now I can really set up shop! Make sure you purchase some goods!
			}
			if (Main.LocalPlayer.wingTimeMax > 0)
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.PlayerHasWings"));
				//Aye, I saw a large fish with wings once...
			}
			if (Main.LocalPlayer.HasItem(ItemID.LadyBug))
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.PlayerHasLadyBug"));
				//I wouldn't use that lady bug as bait if I were you. There are tales of an evil curse being put on you if you do...
			}
			if (Terraria.GameContent.Events.BirthdayParty.PartyIsUp)
            {
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.Party1"), 2.0);
				//That's the biggest catch I've seen yet! Time to celebrate.
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.Party2"), 2.0);
				//I cooked me up some Bumblebee Tuna. Those things are tasty!
			}
			if (Main.bloodMoon)
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.BloodMoon"), 2.0);
			...
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.HowDidIGetHere"), 2.0);
			...
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.SellNothing"), 20.0);
			...
			if (angler >= 0)
			{
				chat.Add(Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerInfo1") + " " + Main.player[Main.myPlayer].anglerQuestsFinished + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerInfo2"), 0.25);
                ...
                {
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest1") + " " + Main.player[Main.myPlayer].anglerQuestsFinished + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest2") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest3") + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest4"), 0.5);
					//So far you have completed # quests for {Name} the Angler. I think it is time for you to start!
				}
				if (Main.player[Main.myPlayer].anglerQuestsFinished > 0)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest1") + " " + Main.player[Main.myPlayer].anglerQuestsFinished + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest2") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest3") + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest5"), 0.5);
					//So far you have completed # quests for {Name} the Angler. Keep at it!
				}
				if (Main.player[Main.myPlayer].anglerQuestsFinished > 9)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest1") + " " + Main.player[Main.myPlayer].anglerQuestsFinished + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest2") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest3") + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest6"), 0.5);
				...
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest7") + " " + Main.player[Main.myPlayer].anglerQuestsFinished + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest2") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest3") + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest9"), 0.5);
                ...
                {
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest8") + " " + Main.player[Main.myPlayer].anglerQuestsFinished + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest2") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest3") + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerQuest9"), 0.5);
					//Nice job, lass! You have completed # quests for {Name} the Angler. Why not keep going?
				}
				//happiness quote
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerHappiness1") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.AnglerHappiness2"), 0.25);
			...
			{
				//happiness quote
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.PirateHappiness1") + " " + Main.npc[pirate].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.PirateHappiness2"), 0.25);
			...
			{
				//happiness quote
				chat.Add(Main.npc[princess].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.PrincessHappiness"), 0.25);
				//{Name} the Princess has offered to get me a fancy new vessel. How kind of her!
			}
			int truffle = NPC.FindFirstNPC(NPCID.Truffle);
			if (truffle >= 0)
			{
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.TruffleNormal1") + " " + Main.npc[truffle].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.TruffleNormal2"), 0.25);
				//I occasionally take Glowing Mushrooms to use as bait. I don't think {Name} knows that I do that, so don't tell 'em!

				//happiness quote
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.TruffleHappiness1") + " " + Main.npc[truffle].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.TruffleHappiness2"), 0.25);
			...
			{
				//happiness quote
				chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.NurseHappiness1") + " " + Main.npc[nurse].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.NurseHappiness2"), 0.25);
			...
			{
				//happiness quote
				chat.Add(Main.npc[mechanic].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.MechanicHappiness"), 0.25);
			...
			if (ModLoader.TryGetMod("ThoriumMod", out Mod thorium))
			{
				...
				if (diverman >= 0)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.ThoriumMod.Diverman1") + " " + Main.npc[diverman].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.ThoriumMod.Diverman2"), 0.25);
			...
			if (ModLoader.TryGetMod("CalamityMod", out Mod calamity))
			{
				...
				if (seaKing >= 0)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.CalamityMod.SeaKing"), 0.25);
					//Amidias is such an interesting person. I hope he doesn't mind me fishin'.
				}
				if (Main.player[Main.myPlayer].Male)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.CalamityMod.Warn1"), 0.25);
					//Careful with mermaids, son, not all of them are friendly.
				}
				else
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.CalamityMod.Warn2"), 0.25);
					//Careful with mermaids, lass, not all of them are friendly.
				}
			}
			if (ModLoader.TryGetMod("SGAmod", out Mod sgamod)) //SGAmod
			{
				if (Main.hardMode)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.SGAmod.Sharkvern"), 0.25);
			...
			if (ModLoader.TryGetMod("Fargowiltas", out Mod fargosMutant))
			{
				...
				if (mutant >= 0)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.FargosMutant.Mutant1") + " " + Main.npc[mutant].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.FargosMutant.Mutant2"), 0.25);
					//The wings that {Name} have remind me of something else...
				}
			}
			if (ModLoader.TryGetMod("NoFishingQuests", out Mod noFishingQuests))
			{
				if (angler >= 0)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.NoFishingQuests.AnglerShop1") + " " + Main.npc[angler].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.NoFishingQuests.AnglerShop2"), 0.25);
			...
			if (ModLoader.TryGetMod("PboneUtils", out Mod pbonesUtilities))
			{
				if (Main.dayTime)
				{
					chat.Add(Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.PbonesUtilities.MysteriousTrader"), 0.25);
			...
			if (ModLoader.TryGetMod("RijamsMod", out Mod rijamsMod))
            {
				...
				if (interTravel >= 0)
				{
					chat.Add(Main.npc[interTravel].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.RijamsMod.InterTravel"), 0.25);
				...
				if (harpy >= 0)
				{
					chat.Add(Main.npc[harpy].GivenName + " " + Language.GetTextValue("Mods.FishermanNPC.NPCDialog.Fisherman.RijamsMod.Harpy"), 0.25);
		...
		{
			button = Language.GetTextValue("Mods.FishermanNPC.UI.Fisherman.Shop1"); //shop1 Bait & Fish
			button2 = Language.GetTextValue("Mods.FishermanNPC.UI.Fisherman.Shop2"); //shop2 Rods & Extras
		}
		...
		public override void SetupShop(Chest shop, ref int nextSlot)
		{
			...
			if (sellFish && shop1)
			{
				...
				{
					if (Main.player[Main.myPlayer].ZoneHallow) //if Hallow
					{
