...
namespace FishermanNPC.NPCs.TownNPCs
{
	...
	public abstract class ModTownEmote : ModEmoteBubble
	{
		...
		public override string Texture => "FishermanNPC/NPCs/TownNPCs/FishermanEmotes";
